...
//    console.log(Meteor.settings.ACCOUNTS_PHONE);
//    console.log(Meteor.settings.ACCOUNTS_PHONE.MASTER_CODE);
  ...
  function login() {
    ...
    */
    var confirmPopup = $ionicPopup.confirm({
      ...
      /*
        what is res?
        what is then? what is a promise?
      */
